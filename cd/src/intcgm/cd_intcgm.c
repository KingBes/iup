...
int cdplayCGM(cdCanvas* canvas, int xmin, int xmax, int ymin, int ymax, void *data)
{
  ...
  funcs.BeginMetafile = (void(*)(const char*,void*))cdcgm_BeginMetafile; 
  funcs.EndMetafile = NULL;
  funcs.BeginPicture = (void(*)(const char*,void*))cdcgm_BeginPicture; 
  funcs.EndPicture = NULL;
  funcs.BeginPictureBody = (void(*)(void*))cdcgm_BeginPictureBody;
  funcs.DeviceExtent = (void(*)(cgmPoint*,cgmPoint*,void*))cdcgm_DeviceExtent; 
  funcs.ScaleMode = (void(*)(int,double*,void*))cdcgm_ScaleMode; 
  funcs.BackgroundColor = (void(*)(cgmRGB,void*))cdcgm_BackgroundColor; 
  funcs.Transparency = (void(*)(int,void*))cdcgm_Transparency; 
  funcs.ClipRectangle = (void(*)(cgmPoint*,cgmPoint*,void*))cdcgm_ClipRectangle; 
  funcs.ClipIndicator = (void(*)(int,void*))cdcgm_ClipIndicator; 
  funcs.PolyLine = (void(*)(cgmPoint*,int,void*))cdcgm_PolyLine; 
  funcs.PolyMarker = (void(*)(cgmPoint*,int,void*))cdcgm_PolyMarker; 
  funcs.Polygon = (void(*)(cgmPoint*,int,void*))cdcgm_Polygon; 
  ...
  funcs.LineAttrib = (void(*)(const char*,const char*,const char*,double,const char*,cgmRGB,void*))cdcgm_LineAttrib; 
  funcs.MarkerAttrib = (void(*)(int,double,cgmRGB,void*))cdcgm_MarkerAttrib; 
  funcs.FillAttrib = (void(*)(const char*,cgmRGB,const char*,cgmPattern*,void*))cdcgm_FillAttrib; 
  funcs.TextAttrib = (void(*)(const char*,const char*,const char*,double,cgmRGB,cgmPoint,void*))cdcgm_TextAttrib; 
  funcs.Counter = (int(*)(double,void*))cdcgm_Counter;
